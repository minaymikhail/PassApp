...
namespace Pass_App
{
	public class Tutor
	{
		...
		public Tutor() { } // must have a default constructor to use SQLite methods 

		public Tutor(string firstName, string lastName, string email, int studentId, string password)
		{
